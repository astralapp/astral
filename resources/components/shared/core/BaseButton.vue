...
const classesForKindProp = {
  base: 'text-gray-700 bg-white border-gray-300 hover:bg-gray-50 focus-visible:ring-gray-200 font-medium active:bg-gray-100 hover:dark:bg-gray-950/50 dark:bg-gray-950 dark:border-black dark:text-gray-200 border shadow-sm dark:shadow-md',
