  ...
  >
    <template #body>
      <form @submit.prevent="renameTag">
        <div>
          <p class="-mt-3 text-center text-gray-500 dark:text-gray-300 sm:-mt-5">Enter a new name for your tag</p>
