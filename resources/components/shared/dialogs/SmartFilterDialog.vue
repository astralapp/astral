...
<template>
  ...
  >
    <div>
      <DialogTitle
        class="rounded-sm bg-gray-50 dark:bg-gray-900/60 px-4 py-3 text-center text-xl font-bold text-gray-700 dark:text-gray-300"
      ...
      <form @submit.prevent="currentSmartFilter ? updateSmartFilter() : addSmartFilter()">
        ...
        <div class="mt-4 flex items-center justify-end space-x-2 rounded-sm bg-gray-50 dark:bg-gray-900/60 px-4 py-3">
          <BaseButton
            kind="base"
            @click="hideDialog"
            >Cancel</BaseButton
