    ...
    <template #contextMenu>
      <div>
        ...
        >
          ...
          <MenuButton
            class="right-0 top-0 h-5 w-5 rounded-sm text-gray-300 opacity-0 transition-opacity hover:text-gray-200 group-hover/sidebar-item:opacity-100 focus-visible:opacity-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-200"
