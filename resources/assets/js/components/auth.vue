...
.auth-statusText {
  @include animation( fadeInOut 2s cubic-bezier(0.1, 0.3, 0.3, 1.0) );
...
.auth-pulser {
  ...
  @include animation-timing-function( cubic-bezier(0.1, 0.3, 0.3, 1.0) );
  @include size( 400px );
  border-radius: 50%;
...
@include keyframes( pulse ) {
  0% {
    @include transform( scale(0.1) translate(-50%, -50%) );
    opacity: 1;
  }
  50% {
    @include transform( scale(1) translate(-50%, -50%) );
