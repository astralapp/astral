...
},{"./classes":13,"contra/emitter":16,"crossvent":20}],15:[function(require,module,exports){
'use strict';
...
},{"ticky":18}],16:[function(require,module,exports){
'use strict';
...
},{"./debounce":15,"atoa":17}],17:[function(require,module,exports){
...
},{"./eventmap":21,"custom-event":19}],21:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./lodash.js":26}],26:[function(require,module,exports){
(function (global){
/**
 * @license
...
var _componentsAuthVue = require("./components/auth.vue");

var _componentsAuthVue2 = _interopRequireDefault(_componentsAuthVue);

var _componentsDashboardVue = require("./components/dashboard.vue");
...
},{"./components/app.vue":60,"./components/auth.vue":61,"./components/dashboard.vue":65,"vue":54,"vue-resource":42,"vue-router":53}],60:[function(require,module,exports){
"use strict";
...
},{"vue":54,"vue-hot-reload-api":28}],61:[function(require,module,exports){
"use strict";
  ...
  route: {
    data: function data(_ref) {
      ...
      if (to.query.token && to.query.access_token) {
        ...
        setTimeout(function () {
          _this.$route.router.go("/dashboard");
        }, 1);
      }
    }
  },
...
},{"local-storage":22,"vue":54,"vue-hot-reload-api":28}],62:[function(require,module,exports){
"use strict";
...
exports.default = {
  ...
  computed: {
    ...
    searchQuery: {
      get: function get() {
        return _store2.default.state.searchQuery;
      },
      set: function set(newValue) {
        _store2.default.actions.setSearchQuery(newValue);
      }
    }
  }
};
...
exports.default = {
  ...
  methods: {
    ...
    setCurrentTag: function setCurrentTag(tag) {
      _store2.default.actions.setCurrentTag(tag);
    },
    clearCurrentTag: function clearCurrentTag() {
      _store2.default.actions.resetCurrentTag();
    }
  }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
exports.default = {
  ...
  ready: function ready() {
    _store2.default.actions.fetchStars();
  ...
  filters: {
    currentTagFilter: function currentTagFilter(arr) {
      var _this = this;

      if (!(0, _keys2.default)(this.currentTag).length) {
        return arr;
      }
      return arr.filter(function (repo) {
        var matchedStar = _this.stars.filter(function (star) {
          return star.repo_id === repo.id;
        })[0];
        if (matchedStar && matchedStar.tags.length) {
          return ~matchedStar.tags.map(function (tag) {
            return tag.name;
          }).indexOf(_this.currentTag.name);
        } else {
          return false;
        }
      });
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/user/Sites/Homestead/astral/resources/assets/js/components/star-info.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
_vue2["default"].directive("dropzone", {
  acceptStatement: true,
  bind: function bind() {},
  update: function update(fn, value) {
    var _this = this;
...
var fetchReadme = function fetchReadme(_ref3, name) {
  var dispatch = _ref3.dispatch;

  var accessToken = (0, _localStorage2["default"])("access_token");
  _vue2["default"].http.get("https://api.github.com/repos/" + name + "/readme?access_token=" + accessToken).then(function (response) {
    var readme = (0, _marked2["default"])(window.atob(response.data.content));
    dispatch(types.SET_README, readme);
  });
};

exports.fetchReadme = fetchReadme;
var setCurrentStar = function setCurrentStar(_ref4, star) {
  var dispatch = _ref4.dispatch;

  dispatch(types.SET_CURRENT_STAR, star);
};

exports.setCurrentStar = setCurrentStar;
//Tags
var fetchTags = function fetchTags(_ref5) {
...
var reorderTags = function reorderTags(_ref6, sortMap) {
...
var addTag = function addTag(_ref7) {
...
var setCurrentTag = function setCurrentTag(_ref8, tag) {
  var dispatch = _ref8.dispatch;

  dispatch(types.SET_CURRENT_TAG, tag);
};

exports.setCurrentTag = setCurrentTag;
var resetCurrentTag = function resetCurrentTag(_ref9) {
  var dispatch = _ref9.dispatch;

  dispatch(types.RESET_CURRENT_TAG);
};

exports.resetCurrentTag = resetCurrentTag;
//Stars
var tagStar = function tagStar(_ref10, starData) {
...
var fetchStars = function fetchStars(_ref11) {
...
//Misc.
var setSearchQuery = function setSearchQuery(_ref12, query) {
...
exports.searchInitialState = searchInitialState;
...
var searchMutations = (_searchMutations = {}, _defineProperty(_searchMutations, _mutationTypesJs.SET_SEARCH_QUERY, function (state, query) {
  state.searchQuery = query;
}), _defineProperty(_searchMutations, _mutationTypesJs.SET_TOKENIZED_SEARCH, function (state, obj) {
...
var readmeInitialState = "";

exports.readmeInitialState = readmeInitialState;
var githubStarsMutations = (_githubStarsMutations = {}, _defineProperty(_githubStarsMutations, _mutationTypesJs.SET_GITHUB_STARS, function (state, stars) {
  ...
  state.cachedPages++;
}), _defineProperty(_githubStarsMutations, _mutationTypesJs.SET_README, function (state, readme) {
  state.readme = readme;
...
var currentStarInitialState = {};

exports.currentStarInitialState = currentStarInitialState;
var starsMutations = (_starsMutations = {}, _defineProperty(_starsMutations, _mutationTypesJs.SET_STARS, function (state, stars) {
  state.stars = stars;
...
var currentTagInitialState = {};

exports.currentTagInitialState = currentTagInitialState;
...
}), _defineProperty(_tagsMutations, _mutationTypesJs.SET_CURRENT_TAG, function (state, tag) {
  state.currentTag = tag;
}), _defineProperty(_tagsMutations, _mutationTypesJs.RESET_CURRENT_TAG, function (state) {
  state.currentTag = {};
}), _tagsMutations);
...
var SET_README = "SET_README";

exports.SET_README = SET_README;
//Tags
...
exports.SET_CURRENT_TAG = SET_CURRENT_TAG;
var RESET_CURRENT_TAG = "RESET_CURRENT_TAG";

exports.RESET_CURRENT_TAG = RESET_CURRENT_TAG;
//Stars
...
var _modulesGalileoJs = require("./modules/galileo.js");
...
exports["default"] = new _vuex2["default"].Store({
  state: {
    ...
    readme: _modulesGithubJs.readmeInitialState,
    currentStar: _modulesStarsJs.currentStarInitialState,
    currentTag: _modulesTagsJs.currentTagInitialState,
    searchQuery: _modulesGalileoJs.searchInitialState,
    tokenizedSearchQuery: _modulesGalileoJs.tokenizedSearchInitialState
  },
  actions: actions,
  mutations: [_modulesUserJs.userMutations, _modulesGithubJs.githubStarsMutations, _modulesTagsJs.tagsMutations, _modulesStarsJs.starsMutations, _modulesGalileoJs.searchMutations]
});
module.exports = exports["default"];
